  ...
  return (
    <section id="offers">
      <div className="flex gap-4 flex-wrap lg:flex-nowrap">
        <div className="offers-box-ver w-full sm:w-[40%] lg:w-[33%] h-[550px] bg-[url(../../src/assets/icecream.jpg)] bg-cover p-6 flex-flex-col pt-6 text-white items-center">
        ...
        <div className="offers-box-ver offers-box-ver w-full sm:w-[40%] lg:w-[33%] h-[550px] bg-[url(../../src/assets/icecream.jpg)] bg-cover p-6 flex-flex-col pt-6 text-white items-center">
        ...
        <div className="offers-box-hor w-full lg:w-[33%] flex flex-col gap-10 h-[550px]">
          <div className="h-[250px] w-full bg-[url(../../src/assets/icecream.jpg)] bg-cover p-6 flex flex-col ga-2 text-white">
